...
%     add_histroy({'Start loading Digital Elevation Model.'});
    ...
    ncols = uicontrol('Style','Edit','String',mat2str(ny),'Position',[140,270,50,20], 'HorizontalAlignment','Right');

    Edit = uicontrol('Style','Text','String','No. of Rows/Lines: ','Position',[20,245,100,15], 'HorizontalAlignment','left','BackgroundColor',colr);
    nrows = uicontrol('Style','Edit','String',mat2str(nx),'Position',[140,245,50,20], 'HorizontalAlignment','Right');
    ...
    northedge = uicontrol('Style','Edit','String',mat2str(y2),'Position',[140,210,50,20], 'HorizontalAlignment','Right');

    Edit = uicontrol('Style','Text','String','South Edge Value: ','Position',[20,185,100,15], 'HorizontalAlignment','left','BackgroundColor',colr);
    southedge = uicontrol('Style','Edit','String',mat2str(y1),'Position',[140,185,50,20], 'HorizontalAlignment','Right');

    Edit = uicontrol('Style','Text','String','West Edge Value: ','Position',[20,160,100,15], 'HorizontalAlignment','left','BackgroundColor',colr);
    westedge = uicontrol('Style','Edit','String',mat2str(x1),'Position',[140,160,50,20], 'HorizontalAlignment','Right');

    Edit = uicontrol('Style','Text','String','East Edge Value: ','Position',[20,135,100,15], 'HorizontalAlignment','left','BackgroundColor',colr);
    eastedge = uicontrol('Style','Edit','String',mat2str(x2),'Position',[140,135,50,20], 'HorizontalAlignment','Right');
    ...
    ress = uicontrol('Style','Edit','String',mat2str(res1),'Position',[140,50,50,20], 'HorizontalAlignment','Right');


    uicontrol('Style','PushButton','String','Import','Position',[10,10,50,20],'CallBack',{@ImportPressed, fls});
    uicontrol('Style','PushButton','String','Save','Position',[70,10,60,20],'CallBack',{@SavePressed, fls});
    ...
    function ImportPressed(h, eventdata, demFile)
        ...
        ##############SavePressed(h, eventdata, demFile);


    end

    function SavePressed(h, eventdata, demFile)

        res = str2num(get(ress,'String'));
        info.dtheta = -0.45;
        info.path = demFile(1:end-4);
        ...
        savefile = strcat(demFile(1:end-4),'_INFO.mat');
